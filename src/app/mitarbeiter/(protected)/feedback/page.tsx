...
import { submitEmployeeFeedback } from "@/actions/feedback";
...
export default async function MitarbeiterFeedbackPage({
  searchParams,
}: {
  ...
  return (
    <div>
      <h1 className="font-display text-2xl font-semibold text-sand-900">Feedback</h1>
      ...
      <div className={`${cardClass} mt-6`}>
        ...
        <form action={submitEmployeeFeedback} className="space-y-4">
          <div>
