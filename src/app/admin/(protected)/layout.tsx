  ...
  return (
    <div className="flex-1 flex flex-col">
      <header className="sticky top-0 z-20 border-b border-card-border/70 dark:border-white/5 bg-card/90 dark:bg-cockpit-header/80 backdrop-blur-xl">
        <div className="mx-auto max-w-[1920px] px-8 h-[74px] flex items-center justify-between gap-6">
      ...
      <main className="relative flex-1 w-full max-w-[1920px] mx-auto px-8 py-7">
        <div
          aria-hidden
