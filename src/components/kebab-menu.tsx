    ...
    <div ref={containerRef} className="relative">
      ...
      {open && (
        <div
          ...
          className={
            panelClassName ??
            "absolute right-0 top-[calc(100%+8px)] z-30 w-56 overflow-hidden rounded-2xl border border-card-border/70 dark:border-white/10 bg-card dark:bg-cockpit-card shadow-warm-lg dark:shadow-2xl dark:shadow-black/40"
          }
        >
