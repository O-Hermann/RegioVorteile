...
export function IntroSection() {
  return (
    <section id="preise" className="py-16 bg-white dark:bg-cockpit-section">
      <div className="mx-auto max-w-4xl px-4 sm:px-6">
        <div className="relative overflow-hidden rounded-2xl border border-petrol-100 dark:border-white/10 bg-petrol-50 dark:bg-gradient-to-br dark:from-cockpit-card dark:to-cockpit-card-dark p-8 sm:p-10 text-center shadow-sm dark:shadow-xl dark:shadow-black/30">
          ...
          <Link
            href="/kontakt"
            className="group relative mt-8 inline-flex items-center gap-2 rounded-full bg-cockpit-accent hover:bg-cockpit-accent-hover px-6 py-3 text-sm font-semibold text-white transition-colors"
          >
            Kontakt aufnehmen
