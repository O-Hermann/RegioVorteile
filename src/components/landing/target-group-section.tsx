      ...
      <div className="mx-auto max-w-6xl px-4 sm:px-6">
        ...
        <div className="mt-12 grid gap-6 sm:grid-cols-2">
          {GROUPS.map(({ icon: Icon, text }) => (
            <div
              key={text}
              className="flex items-start gap-4 rounded-2xl border border-petrol-100 dark:border-white/10 bg-white dark:bg-slate-900 p-5 shadow-sm"
            >
              <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-xl bg-petrol-100 dark:bg-cyan-500/10 text-petrol-700 dark:text-cyan-300">
