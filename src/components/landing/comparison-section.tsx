    ...
    <section className="py-20 border-y border-slate-200 dark:border-white/10 bg-slate-50 dark:bg-slate-900">
      <div className="mx-auto max-w-4xl px-4 sm:px-6">
        ...
        <div className="mt-10 overflow-x-auto">
          <div className="min-w-[560px] rounded-2xl border border-slate-200 dark:border-white/10 bg-white dark:bg-slate-950 overflow-hidden">
            <div className="grid grid-cols-3 gap-px bg-slate-200 dark:bg-white/10 text-sm font-semibold">
              ...
              <div className="bg-white dark:bg-slate-950 px-4 py-3 text-sky-700 dark:text-cyan-300">
                Controlling Cockpit
              </div>
            </div>
            {ROWS.map((row) => (
              <div key={row.label} className="grid grid-cols-3 gap-px bg-slate-200 dark:bg-white/10 text-sm">
                ...
                <div className="bg-white dark:bg-slate-950 px-4 py-3.5 flex items-start gap-2 text-slate-800 dark:text-slate-200">
                  <CheckCircleIcon className="mt-0.5 h-4 w-4 shrink-0 text-sky-600 dark:text-cyan-300" />
                  {row.cockpit}
                </div>
              </div>
            ))}
