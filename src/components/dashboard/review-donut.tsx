  ...
  return (
    <div className="flex min-h-0 flex-col overflow-hidden rounded-2xl border border-card-border dark:border-dash-line bg-card dark:bg-[linear-gradient(180deg,rgba(17,43,72,0.97),rgba(11,31,53,0.99))] p-3.5 shadow-warm-sm dark:shadow-[inset_0_1px_0_rgba(255,255,255,0.032),0_16px_36px_rgba(0,0,0,0.19)]">
      <div className="flex shrink-0 items-center justify-between gap-2">
        ...
        <span className="inline-flex shrink-0 items-center gap-1.5 whitespace-nowrap rounded-full border border-card-border px-2 py-1 text-[10.5px] font-semibold text-sand-500 dark:border-[rgba(37,216,206,0.16)] dark:bg-[rgba(37,216,206,0.055)] dark:text-[#b9f9f5]">
      ...
      <div className="mt-1.5 flex items-center justify-between gap-2 rounded-[10px] border border-card-border/60 bg-sand-50/60 px-2.5 py-1.5 dark:border-[rgba(71,108,140,0.19)] dark:bg-[linear-gradient(180deg,rgba(8,29,50,0.62),rgba(7,25,44,0.44))]">
        <div className="flex min-w-0 flex-col gap-0.5">
          <span className="text-[9.5px] font-bold uppercase tracking-wide text-sand-400 dark:text-[#718fa8]">Bearbeitungsstatus</span>
          <strong className="truncate text-[12.5px] font-bold text-sand-900 dark:text-[#eef8ff]">18 neue Fälle warten auf Prüfung</strong>
        </div>
        <span className="shrink-0 whitespace-nowrap text-right text-[9.8px] text-sand-500 dark:text-[#7f9ab2]">
          <b className="block text-[12px] font-bold text-sand-900 dark:text-[#d7e8f5]">12 Min.</b>Ø Prüfzeit
        </span>
      </div>
      ...
      <div className="mt-1.5 grid grid-cols-[108px_1fr] items-center gap-3">
        ...
        <div className="grid gap-1">
          {LEGEND.map((leg) => (
            <div
              key={leg.label}
              className={`grid grid-cols-[1fr_auto_32px] items-center gap-2 rounded-lg px-1.5 py-1 text-[11.5px] ${
            ...
            >
              ...
              <em className="text-right text-[10.4px] not-italic text-sand-400 tabular-nums dark:text-[#7f9ab2]">{leg.share}</em>
            </div>
          ))}
        </div>
      </div>
