...
export function LandingFooter() {
  return (
    <footer className="mt-auto border-t border-petrol-100 dark:border-white/10 bg-petrol-50 dark:bg-slate-950">
      <div className="mx-auto max-w-6xl px-4 sm:px-6 py-10 grid gap-8 sm:grid-cols-3 text-sm">
        ...
        <div>
          ...
          <p className="text-slate-600 dark:text-slate-400">
            ...
            <a href={`mailto:${CONTACT_EMAIL}`} className="text-petrol-800 dark:text-cyan-300 hover:underline">
              {CONTACT_EMAIL}
            </a>
          </p>
          <p className="mt-2">
